<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted small mb-0">Create a new dynamic attribute for product categories</p>
            </div>
    ...
    <div class="container py-4">
        <form method="POST" action="{{ route('admin.attributes.store') }}" id="attribute-form">
            @csrf
            ...
            <div id="options-section" class="form-card" style="display: none;">
                <div class="form-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3>
                            <div class="section-icon">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const type = document.getElementById('type').value;
            if (type) {
                // Trigger change event to show/hide options section
