<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="h4 mb-1 text-dark fw-bold">Create New Category</h2>
                <p class="text-muted small mb-0">Add a new category to organize your products</p>
            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          ...
                                          placeholder="Enter a detailed description of the category">{{ old('description') }}</textarea>
